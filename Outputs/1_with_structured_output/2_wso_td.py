...
'''
Annotated ---> is way to attach extra metadata to give additional instructions or to avoid ambiguity
...
class Review(TypedDict):
    ...
    sentiment: Annotated[Literal['pos', 'neg'], "Return sentiment of the review either positive, negavtive or neutral"]
    key_themes: Annotated[list[str], "Write down all the key themes disscussed in the review in a list"]
    pros: Annotated[list[str], "Write down all pros inside a list"] 
    cons: Annotated[list[str], "Write down all cons inside a list"]
    reviewer: Annotated[Optional[str], "Name of the reviewer, or null if not provided"]
...
# Only problem with this is that you have no VALIDATIONS!
